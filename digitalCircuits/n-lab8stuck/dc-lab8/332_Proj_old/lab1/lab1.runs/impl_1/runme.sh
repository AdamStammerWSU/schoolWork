...
HD_PWD='C:/Users/is2751zv/Documents/git/schoolWork/digitalCircuits/dc-lab7/332_Proj/lab1/lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tryAfter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tryAfter.tcl -notrace
