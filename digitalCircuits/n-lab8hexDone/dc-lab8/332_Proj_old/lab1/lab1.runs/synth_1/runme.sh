...
HD_PWD='C:/Users/is2751zv/Documents/git/schoolWork/digitalCircuits/dc-lab7/332_Proj/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tryAfter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tryAfter.tcl
