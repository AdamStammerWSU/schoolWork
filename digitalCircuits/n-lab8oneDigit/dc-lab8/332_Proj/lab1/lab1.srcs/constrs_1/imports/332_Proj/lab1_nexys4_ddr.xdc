...
set_property PACKAGE_PIN U9 [get_ports data_in]					
...
set_property PACKAGE_PIN T8 [get_ports {decoded_data[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[0]}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {decoded_data[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {decoded_data[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[2]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
set_property PACKAGE_PIN T6 [get_ports {decoded_data[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[3]}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
set_property PACKAGE_PIN T5 [get_ports {decoded_data[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[4]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
set_property PACKAGE_PIN T4 [get_ports {decoded_data[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[5]}]
#Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
set_property PACKAGE_PIN U7 [get_ports {decoded_data[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[6]}]
#Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
set_property PACKAGE_PIN U6 [get_ports {decoded_data[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[7]}]
#Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
set_property PACKAGE_PIN V4 [get_ports {decoded_data[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[8]}]
#Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
set_property PACKAGE_PIN U3 [get_ports {decoded_data[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[9]}]
#Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
set_property PACKAGE_PIN V1 [get_ports {decoded_data[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[10]}]
#Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
set_property PACKAGE_PIN R1 [get_ports {decoded_data[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[11]}]
#Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
set_property PACKAGE_PIN P5 [get_ports {decoded_data[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_data[12]}]
#Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN U1 [get_ports data_req]					
	set_property IOSTANDARD LVCMOS33 [get_ports data_req]
