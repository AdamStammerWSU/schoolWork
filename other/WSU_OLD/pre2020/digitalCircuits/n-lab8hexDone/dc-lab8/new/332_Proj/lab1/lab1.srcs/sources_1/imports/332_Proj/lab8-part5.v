...
module implement_clocks(
    ...
    write_17 w(CLK1KHZ, ctr[3:0], ctr[7:4], ctr[11:8], ctr[15:12], AN, CAs);
...
module digitCode(
    ...
    begin
     ...
     4'b1010: l = 8'b00010001; // "A"
     4'b1011: l = 8'b11000001; // "B"
     4'b1100: l = 8'b01100011; // "C"
     4'b1101: l = 8'b10000101; // "D"
     4'b1110: l = 8'b01100001; // "E"
     4'b1111: l = 8'b01110001; // "F"
